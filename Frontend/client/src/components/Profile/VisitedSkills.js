...
class VisitedSkills extends Component {
  state = {
    skillarr: [],
    skillname: ""
  };
  ...
  componentDidMount() {
    ...
    try {
      ...
      axios
        .get(`${api_route.host}/student/profile/skills/${window.localStorage.getItem('visitedstudent')}`, config)
        .then(res => {
